...
function Courses() {
  ...
  return (
    <>
      <div className="flex bg-gradient-to-r from-blue-800 via-cyan-600 to-teal-700">
        ...
        <aside
          className={`fixed top-0 left-0 h-screen  w-64 p-5 transform z-10 transition-transform duration-300 ease-in-out ${
